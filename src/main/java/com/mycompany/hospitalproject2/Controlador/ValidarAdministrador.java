...
import com.mycompany.hospitalproject2.DAO.AdministradorDAO;
...
public class ValidarAdministrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ValidarAdministrador</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ValidarAdministrador at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String botonRegistrarPaciente = request.getParameter("btn_registrarAdmin");
        if(botonRegistrarPaciente.equalsIgnoreCase("Registrar")){
            String user = request.getParameter("txt_userAdmin");
            String pass = DigestUtils.md5Hex(request.getParameter("txt_passwordAdmin"));
